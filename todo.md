...
- [ ] バリアントが2つ以上のスロット選択時、情報パネルにバリアントボタン行が表示される
- [ ] バリアントが1つのスロット選択時、バリアントボタン行が非表示になる
- [ ] 選択解除時、バリアントボタン行が非表示になる
- [ ] バリアントボタン数がバリアント数と一致する
- [ ] 現在選択中のバリアントボタンが強調（pressed）状態になる
- [ ] バリアントボタンをクリックするとバリアントが切り替わり slot_selected が発火する
- [ ] T キーで循環するとバリアントボタンの強調が更新される
